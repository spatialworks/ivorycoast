...
[![Travis build status](https://travis-ci.org/spatialworks/ivorycoast.svg?branch=master)](https://travis-ci.org/spatialworks/ivorycoast)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/spatialworks/ivorycoast?branch=master&svg=true)](https://ci.appveyor.com/project/spatialworks/ivorycoast)
<!-- badges: end -->
